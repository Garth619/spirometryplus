	...
	<div id="main-content" class="<?php echo esc_attr($page_column_class['main_class']); ?>">
		<article class="single single-post">
			...
			<?php if( $show_blog_thumbnail ): ?>
				<div class="entry-format">
					<?php if( $post_format == 'gallery' || $post_format === false || $post_format == 'standard' ){ ?>
						<figure class="<?php echo ($post_format == 'gallery')?'gallery loading':'' ?>">
							<?php 
			...
			<div class="entry-content <?php echo !$show_blog_thumbnail?'no-thumbnail':'' ?>">
				<div class="entry-meta <?php echo ( $boxshop_theme_options['ts_blog_details_date'] )?'has-datetime':'' ?> <?php echo ( $boxshop_theme_options['ts_blog_details_author'] )?'has-author':'' ?>">
					<!-- Blog Date Time -->
					...
					<!-- Blog view -->
					<?php if( $boxshop_theme_options['ts_blog_details_view'] ): ?>
				...
				<div class="meta-bottom-wrapper">
					...
					<div class="meta-bottom-1 <?php echo ($boxshop_theme_options['ts_blog_details_categories'])?'has-categories':'' ?> <?php echo ($boxshop_theme_options['ts_blog_details_sharing'])?'has-social':'' ?>">
						<!-- Blog Categories -->
						<?php
